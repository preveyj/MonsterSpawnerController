--Deployment script for the Display Computer
...
local computerDirectory = "displayComputer"
local commonUtilsDirectory = "commonUtils"
local expectedFileExtension = ".lua"

local specificFilesToGet = {"fileWriter", "mainSpawnerDisplay", "monitorController", "monitorGetter", "monsterTable" }
